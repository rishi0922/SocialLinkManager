    ...
    try {
        ...
        try {
            ...
            const messages: Record<string, string[]> = {
                ...
                instagram: ["📸 Double tap, now save!", "✨ Your aesthetic just got company.", "🖼️ That vibe is now in your collection.", "📷 Saved before the algorithm buries it.", "💅 Flawless. Pinned to your digital mood board.", "🕵️ Who are you stalking? 😏👀"],
                ...
                linkedin:  ["💼 Networking level: archived.", "📊 Very professional. Very saved.", "🤝 Synergizing your link collection.", "🏢 Career move? Saved for later hustle.", "💡 Big brain LinkedIn energy, stored.", "👀 Still searching for that job, huh? 😅"],
